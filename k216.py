...
melody += (A5/4^1) + (F5s/4^1) + (D5/4) + (A4/4) + (F4s/4^1) + (D4/4^1) + (G4/4) + (E4/4) + (C4s/4^1) + (A3/4^1)
melody += (F4s/4) + (D4/4) + (G4/4) + (E4/4) + (A4/3) + (Z/3)

melody += (A4/4^1) + (F4s/4^1) + (B4/4^1) + (G4/4^1) + (C5s/4^1) + (A4/4^1) + (D5/4) + (A4/4) + (E5/4) + (C5s/4)
melody += (F5s/4^1) + (D5/4^1) + (G5/4^1) + (E5/4^1) + (A5/4^1) + (F5s/4^1) + (A5s/4^1) + (F5s/4^1) + (B5/2) + (D6/2)
melody += (E5/1) + (E5/4) + (F5/4) + (G5/4) + (F5/4) + (A5/4) + (G5/3) + (F5s/4) + (E5/4) + (D5/2)
